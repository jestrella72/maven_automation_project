...
//I want to be able to sort and filter the highest to lowest phone and click on the cheapest one.

public class A106_Tmobile_hightest_lowest {
    ...
    public void ShopNow() throws InterruptedException {
        logger = reports.startTest("Highest to Lowest");
