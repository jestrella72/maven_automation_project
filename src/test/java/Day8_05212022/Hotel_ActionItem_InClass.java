...
public class Hotel_ActionItem_InClass {
...
//define the webdriver I am going to use
        ...
        for (int i = 0; i < destinations.size(); i++) {
            ...
            //click on going to
            try {
                WebElement findGoingto = driver.findElement(By.xpath("//*[@aria-label = 'Going to']"));
                findGoingto.click();
                //driver.findElement(By.xpath("//*[@aria-label = 'Going to']")).click(); another way
                Thread.sleep(1000);
            } catch (Exception e) {
            ...
            try {
                ...
                Thread.sleep(1000);
                //select and click on the the first suggestion when you inspect element Los Angeles
            ...
            //increase travelers x4 go and click on 4
            try {
            ...
            //click submit now you inspect the search button
            try {
